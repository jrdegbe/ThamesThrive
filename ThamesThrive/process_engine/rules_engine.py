...
from ThamesThrive.service.wf.domain.error_debug_info import ErrorDebugInfo
from ThamesThrive.service.wf.domain.debug_info import FlowDebugInfo
...
from ThamesThrive.service.wf.domain.entity import Entity as WfEntity
            ...
            for flow_id, event_id, rule_name, task in tasks:  # type: str, str, str, Task
                try:
                    ...
                    console = Console(
                        ...
                        flow_id=flow_id,
                        module='ThamesThrive.process_engine.rules_engine',
                        class_name="RulesEngine",
                        type="error",
                        message=repr(e),
                        traceback=get_traceback(e)
