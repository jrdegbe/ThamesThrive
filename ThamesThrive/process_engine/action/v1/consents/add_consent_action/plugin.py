from westgate.domain.consent_type import ConsentType
...
from westgate.service.storage.driver.elastic import consent_type as consent_type_db
from pytimeparse import parse
from datetime import datetime
from westgate.domain.profile import ConsentRevoke
...
def register() -> Plugin:
    return Plugin(
        start=False,
        spec=Spec(
            module='westgate.process_engine.action.v1.consents.add_consent_action.plugin',
                        ...
                        fields=[
                            FormField(
                                ...
                                description="Select the reference path to consents. The most possible use-case is when "
                                            "customer grants consents by filling a form. This data is sent to westgate as "
