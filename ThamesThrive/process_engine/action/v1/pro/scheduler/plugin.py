...
import ThamesThrive.config
from ThamesThrive.domain.scheduler_config import SchedulerConfig
from ThamesThrive.exceptions.log_handler import log_handler
from ThamesThrive.process_engine.action.v1.pro.scheduler.model.configuration import Configuration
from ThamesThrive.process_engine.action.v1.pro.scheduler.service.schedule_client import SchedulerClient
...
logger.setLevel(ThamesThrive.config.ThamesThrive.logging_level)
...
class SchedulerPlugin(ActionRunner):
    ...
    async def run(self, payload: dict, in_edge=None) -> Result:
        try:
            client = SchedulerClient(ThamesThrive.config.ThamesThrive.ThamesThrive_scheduler_host)
            ...
            response = {
                "response": {
                    ...
                    "server": ThamesThrive.config.ThamesThrive.ThamesThrive_scheduler_host
                },
                "payload": payload
            }
