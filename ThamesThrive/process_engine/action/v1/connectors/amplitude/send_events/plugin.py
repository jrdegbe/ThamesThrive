...
from westgate.config import westgate
...
from westgate.service.plugin.domain.register import Plugin, Spec, MetaData
    ...
    async def run(self, payload: dict, in_edge=None) -> Result:
        ...
        try:
            ...
            async with HttpClient(
                ...
                event = {
                    "app_version": str(westgate.version),
