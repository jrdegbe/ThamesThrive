...
from westgate.service.mailchimp_sender import MailChimpTransactionalSender
from westgate.process_engine.action.v1.connectors.mailchimp.transactional_email.model.config import Config, Token
from westgate.service.notation.dot_template import DotTemplate
...
def register() -> Plugin:
    return Plugin(
        start=False,
        spec=Spec(
            module='westgate.process_engine.action.v1.connectors.mailchimp.transactional_email.plugin',
