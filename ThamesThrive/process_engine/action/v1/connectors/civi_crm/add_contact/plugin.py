from westgate.domain.resource_config import ResourceConfig
from westgate.service.plugin.domain.register import Plugin, Spec, MetaData, Documentation, PortDoc, Form, FormField, \
...
from westgate.process_engine.action.v1.connectors.civi_crm.client import CiviCRMClient, CiviCRMClientException, \
