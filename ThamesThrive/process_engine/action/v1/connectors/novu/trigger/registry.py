from westgate.process_engine.action.v1.connectors.novu.trigger.plugin import Endpoint
from westgate.service.plugin.domain.register import Plugin, Spec, Form, FormGroup, FormField, FormComponent, MetaData, \
...
def register() -> Plugin:
    return Plugin(
        start=False,
        spec=Spec(
            module='westgate.process_engine.action.v1.connectors.novu.trigger.plugin',
                        ...
                        fields=[
                            ...
                            FormField(
                                ...
                                component=FormComponent(type="autocomplete", props={
                                    ...
                                    "endpoint": {
                                        "url": Endpoint.url(
                                            'westgate.process_engine.action.v1.connectors.novu.trigger.plugin',
                                            'get_tenants'),
                                        "method": "post"
                                    },
                                })
