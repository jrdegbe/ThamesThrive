...
from westgate.domain.resources.elastic_resource_config import ElasticResourceConfig, ElasticCredentials
...
from westgate.service.storage.elastic_client import ElasticClient
