from westgate.process_engine.action.v1.connectors.google.analytics_v4.plugin import GoogleAnalyticsV4EventTrackerAction
...
def register() -> Plugin:
    return Plugin(
        start=False,
        spec=Spec(
            module='westgate.process_engine.action.v1.connectors.google.analytics_v4.plugin',
