...
from westgate.process_engine.action.v1.connectors.github.forms.GitHubFormFields import form_field_github_resource, \
...
from westgate.process_engine.action.v1.connectors.github.model.config import GitHubBaseConfiguration, \
    init_github_base_configuration
from westgate.service.plugin.domain.register import Plugin, Spec, Form, MetaData, FormGroup, \
