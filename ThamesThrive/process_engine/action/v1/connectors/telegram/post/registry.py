from westgate.process_engine.action.v1.connectors.telegram.post.plugin import TelegramPostAction
...
def register() -> Plugin:
    return Plugin(
        start=False,
        spec=Spec(
            module='westgate.process_engine.action.v1.connectors.telegram.post.plugin',
