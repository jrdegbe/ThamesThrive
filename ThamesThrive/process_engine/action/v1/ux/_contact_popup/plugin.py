...
from ThamesThrive.service.notation.dot_template import DotTemplate
...
class ContactPopupPlugin(ActionRunner):
    ...
    async def run(self, payload: dict, in_edge=None) -> Result:
        ...
        self.ux.append({
            "tag": "div",
            "props": {
                "class": "ThamesThrive-uix-contact-widget",
                        ...
                        fields=[
                            FormField(
                                ...
                                description="Provide URL where the micro frontend source is located. Usually it is the "
                                            "location of ThamesThrive API. Type different location if you use CDN.",
                                component=FormComponent(type="text", props={"label": "URL"})
                            ),
                            FormField(
                                id="api_url",
                                name="API URL",
                                description="Provide a URL of ThamesThrive instance to send event with contact data.",
