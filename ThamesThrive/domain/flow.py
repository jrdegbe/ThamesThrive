...
from ThamesThrive.service.wf.domain.flow_graph_data import FlowGraphData, EdgeBundle
from ThamesThrive.service.plugin.domain.register import MetaData, Plugin, Spec, NodeEvents, MicroserviceConfig

from ..config import ThamesThrive
...
class FlowSchema(BaseModel):
    version: str = ThamesThrive.version.version
    uri: str = 'http://www.ThamesThrive.com/2021/WFSchema'
    server_version: str = None

    def __init__(self, **data: Any):
        super().__init__(**data)
        self.server_version = ThamesThrive.version.version
...
class Flow(FlowGraph):
    ...
    def new(id: str = None) -> 'Flow':
        return Flow(
            ...
            timestamp=now_in_utc(),
            name="Empty",
            wf_schema=FlowSchema(version=str(ThamesThrive.version)),
