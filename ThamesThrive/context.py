...
class Context:
    ...
    production: bool = ThamesThrive.version.production
    ...
    def __init__(self,
        ...
        self.user = user
        self.production = ThamesThrive.version.production if production is None else production
        self.host = host
