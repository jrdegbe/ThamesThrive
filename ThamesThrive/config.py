...
from ThamesThrive.domain.yaml_config import YamlConfig
from ThamesThrive.service.singleton import Singleton
from ThamesThrive.service.utils.environment import get_env_as_int
from ThamesThrive.service.utils.validators import is_valid_url
...
class ThamesThriveConfig(metaclass=Singleton):
    ...
    def __init__(self, env):
        ...
        self.ThamesThrive_pro_host = env.get('ThamesThrive_PRO_HOST', 'pro.ThamesThrive.com')
        self.ThamesThrive_pro_port = get_env_as_int('ThamesThrive_PRO_PORT', 40000)
        self.ThamesThrive_scheduler_host = env.get('ThamesThrive_SCHEDULER_HOST', 'scheduler.ThamesThrive.com')
        ...
        self.installation_token = env.get('INSTALLATION_TOKEN', 'ThamesThrive')
...
ThamesThrive = ThamesThriveConfig(os.environ)
