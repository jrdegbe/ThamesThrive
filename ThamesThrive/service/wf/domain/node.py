...
import ThamesThrive.service.wf
...
from ThamesThrive.service.plugin.domain.register import RunOnce, NodeEvents, MicroserviceConfig
...
class Node(Entity):
    ...
    def get_input_nodes(self, nodes) -> Iterator[ThamesThrive.service.wf.domain.flow_graph_data.Node]:
        index_of_nodes = index_nodes(nodes)  # type: Dict[str, ThamesThrive.service.wf.domain.flow_graph_data.Node]
