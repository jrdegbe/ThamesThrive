...
from ThamesThrive.domain.resource_settings import ResourceSettings, DestinationData
from typing import List

if License.has_license():
    from com_ThamesThrive.resource.resource_types import commercial_resource_types
...
def get_resource_types() -> List[ResourceSettings]:
    os_resource_types = [
        ...
        ResourceSettings(
            ...
            destination=DestinationData(
                package="ThamesThrive.process_engine.destination.mautic_connector.MauticConnector",
                init={
        ...
        ResourceSettings(
            ...
            destination=DestinationData(
                package="ThamesThrive.process_engine.destination.civicrm_connector.CiviCRMConnector"
            ),
        ...
        ResourceSettings(
            ...
            destination=DestinationData(
                package="ThamesThrive.process_engine.destination.pulsar_connector.PulsarConnector",
                init={
                    "topic": "<topic>",
                    "serializer": "json"
                }
