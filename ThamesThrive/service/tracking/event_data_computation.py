...
from ThamesThrive.service.tracking.profile_data_computation import map_event_to_profile
...
from ThamesThrive.service.events import get_default_mappings_for
from ThamesThrive.service.tracking.utils.function_call import default_event_call_function
from ThamesThrive.service.utils.getters import get_entity_id

if License.has_license():
    from com_ThamesThrive.service.event_mapper import map_event_props_to_traits, map_events_tags_and_journey
...
async def compute_events(events: List[EventPayload],
    ...
    if profile:
        try:
            ...
            if not ThamesThrive.skip_errors_on_profile_mapping:
                raise e
