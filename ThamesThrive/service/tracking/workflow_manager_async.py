...
from ThamesThrive.process_engine.rules_engine import RulesEngine
...
from ThamesThrive.service.wf.domain.flow_response import FlowResponses
...
class WorkflowManagerAsync:
    ...
    async def trigger_workflows_for_events(self, events: List[Event], debug: bool = False) -> TrackerResult:
        ...
        event_trigger_rules = await self.get_routing_rules(events) if ThamesThrive.enable_workflow else None
        ...
        try:
            ...
            if ThamesThrive.enable_workflow and event_trigger_rules is not None:
            ...
            # Debug data
            if ThamesThrive.track_debug or debug:
