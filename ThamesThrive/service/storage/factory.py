...
from ThamesThrive.service.storage.elastic_storage import ElasticStorage, ElasticFiledSort
from ThamesThrive.service.storage.persistence_service import PersistenceService
from ThamesThrive.domain.entity import Entity
from pydantic import BaseModel
from ThamesThrive.domain.agg_result import AggResult
from ThamesThrive.exceptions.exception import ThamesThriveException, StorageException
...
import ThamesThrive.domain.entity as domain
...
class CollectionCrud:
    ...
    async def save(self, replace_id: bool = True, exclude=None) -> BulkInsertResult:
        if not isinstance(self.payload, list):
            raise ThamesThriveException("CollectionCrud data payload must be list.")
