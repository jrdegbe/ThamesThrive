...
setup(
    name='ThamesThrive',
    version='0.8.2-dev',
    description='ThamesThrive Customer Data Platform backend',
    long_description=long_description,
    long_description_content_type="text/markdown",
    author='Derek Degbe',
    author_email='derekjr560@gmail.com',
    packages=['ThamesThrive'],
    install_requires=[
        'pip>=21.2.4',
        'pydantic>=2.3.0',
        'aiohttp[speedups]',
        ...
        'lark==1.1.2',
        'dateparser',
        'dotty-dict @ git+https://github.com/ThamesThrive/dotty_dict@master#egg=dotty-dict',
        'pytz',
